            ...
            for (i in obj) {
                ...
                if (LastId != nContentId) {
                    ...
                    if (obj[i].contentTypeId == "1") {
                        ...
                        if (obj[i].filName != '' || obj[i].filName != null) {
                            DataToAppend = DataToAppend + "<ul class=\"tod-list\"><li><a href=\"../../" + obj[i].filDirectory + "/" + obj[i].filYear + "/" + obj[i].filMonth + "/" + obj[i].filDay + "/" + "/" + obj[i].filName + "\" download=\"\" class=\"btn btn-default btn-xs pull - left\">Download</a></li></ul>";
                        ...
                        DataToAppend = DataToAppend + "<br></div>";
                        DataToAppend = DataToAppend + "</div>";
                    }
...
function loadLecture_V1(Unid, ContentId) {
    ...
    xhttp.onload = function () {
        ...
        for (i in obj) {
            DataToAppend = DataToAppend + "<div class='card'>";
            DataToAppend = DataToAppend + "<div class='card-header'>";
            DataToAppend = DataToAppend + "<h3 class='card-title'>Title: " + obj[i].contentTitle + " <h3>";
            DataToAppend = DataToAppend + "</div>";
